...
export default function CoachForm({ coach, onSave, onClose }) {
  ...
  return (
    <>
      <motion.div
        ...
        className="fixed inset-0 bg-nearBlack/60 backdrop-blur-md z-50"
        onClick={onClose}
      />
      <motion.div
      ...
      >
        ...
        >
          <h2
            className={`text-3xl font-bold text-${theme.colors.primary} mb-6`}
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label
                className={`block text-${theme.colors.accent} mb-2 text-lg`}
              >
                نام
              </label>
              <input
